from BioinformaticsLab.ComputationalBiology.bio_general.WholeGenomeSequence import WholeGenomeSequence
from BioinformaticsLab.ComputationalBiology.bio_general import Gene
